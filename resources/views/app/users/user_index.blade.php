...
@section('new-content')
    ...
    <section
        class="rounded-2xl border border-neutral-200/70 dark:border-neutral-800/70 bg-white dark:bg-neutral-900 p-6 shadow-soft">
        <div class="avatar-wrap">
            @if(auth()->user()->image)
                <img class="avatar" src="data:image/jpeg;base64,{{ auth()->user()->image }}"
                     alt="{{ auth()->user()->name }}">
            @else
                <img class="avatar" src="{{ asset('assets/img/user_profile/profile_example.png') }}"
                     alt="{{ auth()->user()->name }}">
            @endif
        ...
        <div class="mt-5 grid grid-cols-2 gap-3">
            <button type="button"
                    class="w-full rounded-xl border border-neutral-200/70 dark:border-neutral-800/70 p-3 hover:bg-neutral-50 dark:hover:bg-neutral-800 flex items-center justify-center gap-2">
