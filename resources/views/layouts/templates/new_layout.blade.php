...
<div class="md:grid md:grid-cols-[260px_1fr] md:min-h-screen">
    ...
    <aside
        ...
        <div
            class="mt-auto p-3 rounded-xl bg-gradient-to-br from-brand-50 to-white dark:from-neutral-800 dark:to-neutral-900 border border-neutral-200/70 dark:border-neutral-800/70">
            ...
            <p class="mt-2 text-xs text-neutral-600 dark:text-neutral-400"><span class="font-semibold">62%</span>
                atingido</p>
        </div>
    </aside>
    ...
    <div class="relative flex flex-col min-h-screen md:min-h-0">
        ...
        <header
            class="sticky top-0 z-40 border-b border-neutral-200/70 dark:border-neutral-800/70 bg-white/70 dark:bg-neutral-950/60 backdrop-blur supports-[backdrop-filter]:bg-white/50 supports-[backdrop-filter]:dark:bg-neutral-950/50">
        ...
        <div id="speedDial" class="md:hidden fixed bottom-20 right-4 z-50">
            <div class="relative">
                <!-- Ações -->
                <div id="speedDialActions"
                     class="absolute -top-2 right-1 flex flex-col items-end gap-2 opacity-0 translate-y-3 pointer-events-none transition">
