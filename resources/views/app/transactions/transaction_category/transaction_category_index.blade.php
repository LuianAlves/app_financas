...
@section('new-content')
    ...
    <section class="mt-6">
        ...
        <div id="tcatMenu" class="hidden fixed z-[75] min-w-40 rounded-xl border border-neutral-200/70 dark:border-neutral-800/70 bg-white dark:bg-neutral-900 shadow-soft p-1">
        ...
        {{-- Modal CRUD genérico --}}
        <x-modal id="tcatModal" titleCreate="Nova categoria" titleEdit="Editar categoria" titleShow="Detalhes da categoria" submitLabel="Salvar">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <label class="block">
                    ...
                    <div class="mt-1 inline-flex w-full rounded-xl border border-neutral-200/70 dark:border-neutral-800/70 bg-neutral-50 dark:bg-neutral-800 p-1">
                        ...
                        <label for="ctEnt" class="flex-1 text-center px-3 py-1.5 rounded-lg bg-white dark:bg-neutral-900 shadow-sm cursor-pointer peer-checked:font-medium">Entrada</label>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function cardTemplate(cat){
                ...
                if(typeLabel === 'Entrada') { colorType = '#00d679'; bgType = '#00d6791a'; }
                else if(typeLabel === 'Despesa') { colorType = '#e46c6c'; bgType = '#e46c6c1a'; }
                else { colorType = '#d6c400'; bgType = '#d6c4001a'; }
        ...
        <span class="text-sm">${colorHex}</span>
            ...
            const catCrud = CrudLite({
                ...
                fillForm: (form, cat)=>{
                    ...
                    if (color) color.value = mapped.color; if (colorHex) colorHex.value = mapped.color;
            ...
            (function wireUI(){
                const color = document.getElementById('tcat_color');
                const colorHex = document.getElementById('tcat_color_hex');
                color?.addEventListener('input', ()=>{ if(colorHex) colorHex.value = color.value; });
                ...
                limitSwitch?.addEventListener('change', ()=>{
                    ...
                    if (!limitSwitch.checked){
                        const ml = document.querySelector('#tcatModal [name="monthly_limit"]'); if (ml) ml.value='';
                    }
                });
